...
namespace ArchitectureTest.Tests.Controllers {
    public class NotesControllerTest {
        ...
        public async Task NotesController_GetById_ReturnsNoteDTO() {
            ...
            mockNotesDomain.Setup(nD => nD.GetById(It.IsAny<long>(), It.IsAny<long>())).ReturnsAsync(outputData);
            // Act
        ...
        public async Task NotesController_GetById_ThrowsUnknownErrorOnUnhandledException(bool useCustomException) {
            ...
            if (useCustomException) {
                mockNotesDomain.Setup(nD => nD.GetById(It.IsAny<long>(), It.IsAny<long>())).ThrowsAsync(ErrorStatusCode.UnknownError);
            }
            else {
                mockNotesDomain.Setup(nD => nD.GetById(It.IsAny<long>(), It.IsAny<long>())).ThrowsAsync(new Exception("Any exception message"));
            }
        ...
        public async Task NotesController_GetAll_ReturnsListOfNotes() {
            ...
            mockNotesDomain.Setup(nD => nD.GetUserNotes(It.IsAny<long>())).ReturnsAsync(outputData);
            // Act
        ...
        public async Task NotesController_GetAll_ThrowsUnknownErrorOnUnhandledException(bool useCustomException) {
            // Arrange
            if (useCustomException) {
                mockNotesDomain.Setup(nD => nD.GetUserNotes(It.IsAny<long>())).ThrowsAsync(ErrorStatusCode.UnknownError);
            }
            else {
                mockNotesDomain.Setup(nD => nD.GetUserNotes(It.IsAny<long>())).ThrowsAsync(new Exception("Any exception message"));
            }
        ...
        public async Task NotesController_Put_ReturnsNoteDTO() {
            ...
            mockNotesDomain.Setup(nD => nD.Put(It.IsAny<long>(), It.IsAny<NoteDTO>(), It.IsAny<long>())).ReturnsAsync(outputData);
            // Act
        ...
        public async Task NotesController_Put_ThrowsUnknownErrorOnUnhandledException(bool useCustomException) {
            ...
            var inputData = new NoteDTO { Title = title, Content = content, UserId = userId };
            if (useCustomException) {
                mockNotesDomain.Setup(nD => nD.Put(It.IsAny<long>(), It.IsAny<NoteDTO>(), It.IsAny<long>())).ThrowsAsync(ErrorStatusCode.UnknownError);
            }
            else {
                mockNotesDomain.Setup(nD => nD.Put(It.IsAny<long>(), It.IsAny<NoteDTO>(), It.IsAny<long>())).ThrowsAsync(new Exception("Any exception message"));
            }
        ...
        public async Task NotesController_Delete_Returns204NoContent() {
            ...
            mockNotesDomain.Setup(nD => nD.Delete(It.IsAny<long>(), It.IsAny<long>())).ReturnsAsync(true);
            // Act
        ...
        public async Task NotesController_Delete_ThrowsUnknownErrorOnUnhandledException(bool useCustomException) {
            // Arrange
            if (useCustomException) {
                mockNotesDomain.Setup(nD => nD.Delete(It.IsAny<long>(), It.IsAny<long>())).ThrowsAsync(ErrorStatusCode.UnknownError);
            }
            else {
                mockNotesDomain.Setup(nD => nD.Delete(It.IsAny<long>(), It.IsAny<long>())).ThrowsAsync(new Exception("Any exception message"));
            }
