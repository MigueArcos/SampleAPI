...
INSERT INTO ChecklistDetail(ChecklistId, ParentDetailId, TaskName, Status) VALUES (1, 5, 'Mamiferos', 0), (1, 5, 'Peces', 0), (1, 5, 'Aves', 0), (1, 5, 'Reptiles', 0), (1, 5, 'Anfibios', 0)
INSERT INTO ChecklistDetail(ChecklistId, ParentDetailId, TaskName, Status) VALUES (1, 7, 'Leon', 0), (1, 7, 'Perro', 0), (1, 7, 'Ballena', 0)
INSERT INTO ChecklistDetail(ChecklistId, ParentDetailId, TaskName, Status) VALUES (1, 8, 'Pez Ballena', 0)
INSERT INTO ChecklistDetail(ChecklistId, ParentDetailId, TaskName, Status) VALUES (1, 9, 'Aguila', 0), (1, 9, 'Cito', 0)
INSERT INTO ChecklistDetail(ChecklistId, ParentDetailId, TaskName, Status) VALUES (1, 10, 'Serpiente', 0), (1, 10, 'Cocodrilo', 0), (1, 10, 'Tortuga', 0)
INSERT INTO ChecklistDetail(ChecklistId, ParentDetailId, TaskName, Status) VALUES (1, 11, 'Rana', 0)

INSERT INTO ChecklistDetail(ChecklistId, ParentDetailId, TaskName, Status) VALUES (1, 6, 'Gusanos', 0), (1, 6, 'Esponjas', 0), (1, 6, 'Estrellas de mar', 0)
