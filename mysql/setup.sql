...
-- dotnet ef dbcontext scaffold "Server=localhost; Database=crud; Uid=self; Pwd=P455w0rd;TreatTinyAsBoolean=true" Pomelo.EntityFrameworkCore.MySql -c DatabaseContext --context-dir Database/MySql -o Database/MySql/Entities --force
